export const projects = [
  {
    title: "Bryzi - AI Task Manager for Students",
    description:
      "Bryzi is an automated task management full-stack web application designed specifically for students. It uses GenAI to rapidly generate tasks in seconds from course schedule images to drastically reduce the time spent on manual task entry.",
  ...
  {
    title: "Makai - Marine Debris Reporting Platform",
    description:
    ...
    githubLink: "https://github.com/HACC-2023/makai",
  },
  {
    title: "OSMICS - UH Manoa ICS Office Space Manager",
    description:
